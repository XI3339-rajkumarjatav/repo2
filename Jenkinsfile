  ...
  stages 
  {
   stage('SCM-Checkout') {
    ...
    { 
      steps 
      {
       bat 'mvn clean deploy -DmuleDeploy -Dmule.version=4.4.0 -Danypoint.username=rk4891 -Danypoint.password=4891@Rajk -Danypoint.app=payloadtransfer-s -Danypoint.environment=Sandbox'
      }
    }
  }
}
